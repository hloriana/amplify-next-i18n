...
function loader(content, inputSourceMap) {
  ...
  if (result.cssText) {
    ...
    this.callback(null, `${result.code}\n\nrequire(${_loaderUtils.default.stringifyRequest(this, outputFilename)});`, (_result$sourceMap = result.sourceMap) !== null && _result$sourceMap !== void 0 ? _result$sourceMap : undefined);
    return;
  }
