...
import Module from '../module'; // Verify if the binding is imported from the specified source

export default function hasImport(t, scope, filename, identifier, source) {
  ...
  const isImportingModule = value => // If the value is an exact match, assume it imports the module
