...
var Slider = function Slider(_ref) {
  ...
  var indexRef = useRef(index); // restPos holds a reference to the adjusted position of the slider
  // when rested

  var restPos = useRef(0);
  var velocity = useRef(0); // visibleIndexes is a Set holding the index of slides that are
  // currently partially or fully visible (intersecting) in the
  // viewport

  var visibleIndexes = useRef(new Set());
  var firstVisibleIndex = useRef(0);
  var lastVisibleIndex = useRef(0); // instances holds a ref to an array of controllers
  ...
  var observer = useRef(null); // we add the slides to the IntersectionObserver:
  ...
  var _useSprings = useSprings(children.length, function (_i) {
  ...
  var bind = useDrag(function (_ref6) {
  ...
  return React.createElement("div", {
    ...
    return React.createElement(animated.div // passing the index as an argument will let our handler know
...
export { Slider };
//# sourceMappingURL=react-soft-slider.esm.js.map
