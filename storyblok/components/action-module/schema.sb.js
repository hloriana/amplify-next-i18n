module.exports = {
	...
	schema: {
		...
		'text': {
			type: 'text',
			description: 'The description text of this action.',
			pos: 8,
			required: true,
			translatable: true
		},
		'behavior': {
			...
			default_value: '',
			description:
				'What type of action should be executed when using this action.',
			pos: 9
		},
	...
	is_nestable: true,
	all_presets: [
		{ id: 882560, name: 'Blog - Action', component_id: 723355, image: '' }
	],
	preset_id: null,
	real_name: 'action_module',
