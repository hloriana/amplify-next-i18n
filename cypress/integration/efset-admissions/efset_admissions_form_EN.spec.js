...
describe('EFSET Admissions Form Test EN market', () => {
  ...
  it('Form successfully submits', () => {
    ...
    cy.location('pathname').should('eq', '/en/efset-admissions/test/');
  })
})
